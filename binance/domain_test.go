...
func TestHostWiring(t *testing.T) {
	...
	if want := "binance://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("binance", "about")
	if err != nil || got.String() != "binance://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want binance://page/about", got.String(), err)
	}
}
