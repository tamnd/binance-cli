...
Most of these come down to network reality or how binance serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

binance rate-limits like any public site. binance already paces
...
Where a surface is gated, binance reads a cookie or token you supply
...
`binance`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what binance actually did
